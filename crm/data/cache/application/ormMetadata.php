  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'where' => 
        array (
          'LIKE' => '(user.first_name LIKE \'{text}\' OR user.last_name LIKE \'{text}\' OR CONCAT(user.first_name, \' \', user.last_name) LIKE \'{text}\' OR CONCAT(user.last_name, \' \', user.first_name) LIKE \'{text}\')',
          '=' => '(user.first_name = \'{text}\' OR user.last_name = \'{text}\' OR CONCAT(user.first_name, \' \', user.last_name) = \'{text}\' OR CONCAT(user.last_name, \' \', user.first_name) = \'{text}\')',
        ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'where' => 
        array (
          'LIKE' => '(contact.first_name LIKE \'{text}\' OR contact.last_name LIKE \'{text}\' OR CONCAT(contact.first_name, \' \', contact.last_name) LIKE \'{text}\' OR CONCAT(contact.last_name, \' \', contact.first_name) LIKE \'{text}\')',
          '=' => '(contact.first_name = \'{text}\' OR contact.last_name = \'{text}\' OR CONCAT(contact.first_name, \' \', contact.last_name) = \'{text}\' OR CONCAT(contact.last_name, \' \', contact.first_name) = \'{text}\')',
        ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'where' => 
        array (
          'LIKE' => '(lead.first_name LIKE \'{text}\' OR lead.last_name LIKE \'{text}\' OR CONCAT(lead.first_name, \' \', lead.last_name) LIKE \'{text}\' OR CONCAT(lead.last_name, \' \', lead.first_name) LIKE \'{text}\')',
          '=' => '(lead.first_name = \'{text}\' OR lead.last_name = \'{text}\' OR CONCAT(lead.first_name, \' \', lead.last_name) = \'{text}\' OR CONCAT(lead.last_name, \' \', lead.first_name) = \'{text}\')',
        ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'where' => 
        array (
          'LIKE' => '(target.first_name LIKE \'{text}\' OR target.last_name LIKE \'{text}\' OR CONCAT(target.first_name, \' \', target.last_name) LIKE \'{text}\' OR CONCAT(target.last_name, \' \', target.first_name) LIKE \'{text}\')',
          '=' => '(target.first_name = \'{text}\' OR target.last_name = \'{text}\' OR CONCAT(target.first_name, \' \', target.last_name) = \'{text}\' OR CONCAT(target.last_name, \' \', target.first_name) = \'{text}\')',
        ),
